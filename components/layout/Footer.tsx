    ...
    <footer className="relative z-10 mt-32 bg-paper">
      ...
      <Container className="grid grid-cols-2 gap-x-8 gap-y-12 py-16 md:grid-cols-6 md:py-20 lg:grid-cols-8">
        <div className="col-span-2 md:col-span-6 lg:col-span-4">
          ...
          <p className="mt-4 w-fit max-w-xs text-sm text-graphite">
            {site.tagline}.
          </p>
        </div>
          ...
          <ul className="space-y-2">
            {nav.map((item) => (
              <li key={item.href} className="w-fit">
                <Link
                  href={item.href}
                  className="link-underline inline-block py-3 text-sm text-ink"
                >
                  {item.label}
                </Link>
              </li>
        ...
        <div className="col-span-2 md:col-span-3 lg:col-span-2 lg:col-start-7">
          ...
          <ul className="space-y-2 wrap-break-word text-sm text-ink">
            <li className="w-fit">
              <a href={site.whatsappUrl} className="link-underline inline-block py-3">
                WhatsApp
              </a>
            </li>
            <li className="w-fit">
              <a href={`mailto:${site.email}`} className="link-underline inline-block py-3">
                {site.email}
              </a>
            </li>
            <li className="w-fit">
              <a href={site.instagram} className="link-underline inline-block py-3">
                Instagram
              </a>
            </li>
          </ul>
